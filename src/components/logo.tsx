const Logo = () => {
    return (
        <svg aria-labelledby="aesop-29" className="Icon_base__GKZ58 Icon_light__1TZsq Logo_icon__NDEf8"
             data-testid="data-testid-Icon" focusable="false" height="40" role="img"
             style={{height: "40px", width: "120px"}}
             fill={"white"}
             tabIndex={-1} viewBox="0 0 489.7 154.3" width="120">
            <title id="aesop-29">Aesop</title>
            <g>
                <path
                ...
                <path
                    d="M291.5,73.5c0,22.3,9.8,34.6,24.5,34.6c15.4,0,25.5-13.3,25.5-34.5c0-12.5-3.9-33.8-24.7-33.8C291.5,39.8,291.5,68.6,291.5,73.5 M357.9,73c0,25.5-17.6,41.5-42,41.5c-17,0-40.8-7.7-40.8-40.6c0-25,16.7-40.6,40.8-40.6 C346.3,33.4,357.9,53.4,357.9,73"></path>
                <path
